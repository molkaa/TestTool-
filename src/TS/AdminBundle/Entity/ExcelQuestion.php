 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="TS\AdminBundle\Entity\ExcelQuestionRepository")
...
class ExcelQuestion
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="TS\AdminBundle\Entity\Tests", cascade={"persist"},mappedBy="excelQuestions")
     */
    private $test;
    /**
     * @var string
