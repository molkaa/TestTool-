 ...
 */
class Status extends \TS\AdminBundle\Entity\Status implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TS\\AdminBundle\\Entity\\Status' . "\0" . 'id', '' . "\0" . 'TS\\AdminBundle\\Entity\\Status' . "\0" . 'status', '' . "\0" . 'TS\\AdminBundle\\Entity\\Status' . "\0" . 'reference', '' . "\0" . 'TS\\AdminBundle\\Entity\\Status' . "\0" . 'team'];
        }
