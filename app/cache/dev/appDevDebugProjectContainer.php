...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'security.firewall.map.context.auth_employee' => 'getSecurity_Firewall_Map_Context_AuthEmployeeService',
            'security.firewall.map.context.auth_login' => 'getSecurity_Firewall_Map_Context_AuthLoginService',
            'security.firewall.map.context.auth_register' => 'getSecurity_Firewall_Map_Context_AuthRegisterService',
            'security.firewall.map.context.dev' => 'getSecurity_Firewall_Map_Context_DevService',
            'security.firewall.map.context.employee_login' => 'getSecurity_Firewall_Map_Context_EmployeeLoginService',
            ...
            'security.user_checker.admin_login' => 'getSecurity_UserChecker_AdminLoginService',
        ...
        $this->aliases = array(
            ...
            'security.user_checker.admin' => 'security.user_checker.admin_login',
            'security.user_checker.auth_employee' => 'security.user_checker.admin_login',
            'security.user_checker.auth_login' => 'security.user_checker.admin_login',
            'security.user_checker.auth_register' => 'security.user_checker.admin_login',
            'security.user_checker.employee_login' => 'security.user_checker.admin_login',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'TestsTools', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\TS\\CandidatBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\TS\\UserBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\TS\\AdminBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\TS\\LDAPBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'TS\\CandidatBundle\\Entity');
        $c->addDriver($b, 'TS\\UserBundle\\Entity');
        $c->addDriver($b, 'TS\\AdminBundle\\Entity');
        $c->addDriver($b, 'TS\\LDAPBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('TSCandidatBundle' => 'TS\\CandidatBundle\\Entity', 'TSUserBundle' => 'TS\\UserBundle\\Entity', 'TSAdminBundle' => 'TS\\AdminBundle\\Entity', 'TSLDAPBundle' => 'TS\\LDAPBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_240a2accad938ffda7d0bf2d293481e76b052a82d2905c71b146cc24c061a2ca');
    ...
    {
        return $this->services['fos_user.listener.authentication'] = new \FOS\UserBundle\EventListener\AuthenticationListener($this->get('fos_user.security.login_manager'), 'auth');
    }
    ...
    {
        return $this->services['fos_user.security.login_manager'] = new \FOS\UserBundle\Security\LoginManager($this->get('security.token_storage'), $this->get('security.user_checker.admin_login'), $this->get('security.authentication.session_strategy'), $this);
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('TS\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.admin_login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/adminLogin$'), 'security.firewall.map.context.employee_login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/employeeLogin$'), 'security.firewall.map.context.admin' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin'), 'security.firewall.map.context.auth_Employee' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/employee'), 'security.firewall.map.context.auth_register' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/register'), 'security.firewall.map.context.auth_login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/login$'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_AdminService()
    {
        ...
        $i = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $b), '2d7db5329764b100aaeb961a210565ce33', 'admin', array('name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $c);

        $j = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $e, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($e, '/adminLogin'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'adminLogout'));
        ...
        $k->setOptions(array('login_path' => 'adminLogin', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $l->setOptions(array('login_path' => 'adminLogin', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $m = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $g, $h, $e, 'admin', $k, $l, array('check_path' => 'adminCheck', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $c, $d, NULL);
        $m->setRememberMeServices($i);

        return $this->services['security.firewall.map.context.admin'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $b), 'admin', $c, $d), 2 => $j, 3 => $m, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $i, $g, $c, $d, true, $h), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '57a1350a7211e7.19376091', $c, $g), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'admin', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, 'adminLogin', false), NULL, NULL, $c, false));
    }
     ...
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance
     */
    protected function getSecurity_Firewall_Map_Context_AuthEmployeeService()
    {
        $a = $this->get('security.token_storage');
        $b = $this->get('fos_user.user_provider.username');
        $c = $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE);
        ...
        $i = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $b), '2d7db5329764b100aaeb961a210565ce33', 'auth_Employee', array('name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $c);

        $j = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $e, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($e, '/employeeLogin'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'employeeLogout'));
        $j->addHandler($this->get('security.logout.handler.session'));
        $j->addHandler($i);

        $k = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($e, array());
        $k->setOptions(array('login_path' => 'employeeLogin', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $k->setProviderKey('auth_Employee');

        $l = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($f, $e, array(), $c);
        $l->setOptions(array('login_path' => 'employeeLogin', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $m = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $g, $h, $e, 'auth_Employee', $k, $l, array('check_path' => 'emplyeeCheck', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $c, $d, NULL);
        $m->setRememberMeServices($i);

        return $this->services['security.firewall.map.context.auth_employee'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $b), 'auth_Employee', $c, $d), 2 => $j, 3 => $m, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $i, $g, $c, $d, true, $h), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '57a1350a7211e7.19376091', $c, $g), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'auth_Employee', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, 'employeeLogin', false), NULL, NULL, $c, false));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_AuthLoginService()
    {
        ...
        return $this->services['security.firewall.map.context.auth_login'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username')), 'auth_login', $b, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '57a1350a7211e7.19376091', $b, $this->get('security.authentication.manager')), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'auth_login', NULL, NULL, NULL, $b, false));
    }

    /**
     * Gets the 'security.firewall.map.context.auth_register' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance
     */
    protected function getSecurity_Firewall_Map_Context_AuthRegisterService()
    {
        $a = $this->get('security.token_storage');
        $b = $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE);

        return $this->services['security.firewall.map.context.auth_register'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username')), 'auth_register', $b, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '57a1350a7211e7.19376091', $b, $this->get('security.authentication.manager')), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'auth_register', NULL, NULL, NULL, $b, false));
    }
    ...
    /**
     * Gets the 'security.firewall.map.context.employee_login' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance
     */
    protected function getSecurity_Firewall_Map_Context_EmployeeLoginService()
    {
        $a = $this->get('security.token_storage');
        $b = $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE);

        return $this->services['security.firewall.map.context.employee_login'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username')), 'employee_login', $b, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '57a1350a7211e7.19376091', $b, $this->get('security.authentication.manager')), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'employee_login', NULL, NULL, NULL, $b, false));
    }
    ...
    /**
     * Gets the 'security.user_checker.admin_login' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_UserChecker_AdminLoginService()
    {
        return $this->services['security.user_checker.admin_login'] = new \Symfony\Component\Security\Core\User\UserChecker();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\TS\\CandidatBundle/Resources/views'), 'TSCandidat');
        $instance->addPath(($this->targetDirs[3].'\\src\\TS\\SRecBundle/Resources/views'), 'TSSRec');
        $instance->addPath(($this->targetDirs[3].'\\src\\TS\\UserBundle/Resources/views'), 'TSUser');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\TS\\AdminBundle/Resources/views'), 'TSAdmin');
        $instance->addPath(($this->targetDirs[3].'\\src\\TS\\LDAPBundle/Resources/views'), 'TSLDAP');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('2d7db5329764b100aaeb961a210565ce33');
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/profile'), array(0 => 'ROLE_EVALUATOR'), NULL);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $b = $this->get('security.user_checker.admin_login');
        $c = $this->get('security.encoder_factory');

        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57a1350a7211e7.19376091'), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57a1350a7211e7.19376091'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'admin', $c, true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($b, '2d7db5329764b100aaeb961a210565ce33', 'admin'), 4 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57a1350a7211e7.19376091'), 5 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'auth_Employee', $c, true), 6 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($b, '2d7db5329764b100aaeb961a210565ce33', 'auth_Employee'), 7 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57a1350a7211e7.19376091'), 8 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57a1350a7211e7.19376091'), 9 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57a1350a7211e7.19376091')), true);
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('admin', 'adminLogout', 'logout', '_csrf_token', NULL);
        $instance->registerListener('auth_Employee', 'employeeLogout', 'logout', '_csrf_token', NULL);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_CANDIDATE', 1 => 'ROLE_EVALUATOR'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_CANDIDATE', 1 => 'ROLE_EVALUATOR', 2 => 'ROLE_ADMIN', 3 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TSCandidatBundle' => 'TS\\CandidatBundle\\TSCandidatBundle',
                'TSSRecBundle' => 'TS\\SRecBundle\\TSSRecBundle',
                'TSUserBundle' => 'TS\\UserBundle\\TSUserBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'TSAdminBundle' => 'TS\\AdminBundle\\TSAdminBundle',
                'ObHighchartsBundle' => 'Ob\\HighchartsBundle\\ObHighchartsBundle',
                'TSLDAPBundle' => 'TS\\LDAPBundle\\TSLDAPBundle',
            ...
            'locale' => 'fr',
            'secret' => '2d7db5329764b100aaeb961a210565ce33',
            ...
            'kernel.secret' => '2d7db5329764b100aaeb961a210565ce33',
