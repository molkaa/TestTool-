$(document).ready(function() {
    ...
    $('#example31').bind('click', function(e) {
        ...
        var res2 = tickResult();
        var verifres = verifresponse();
        var msg="";
        if (res2 >0 || verifres>0)
        {
             msg ='<strong>You have some questions to review or to answer !</strong><br><br> Would you like to continue ?'
        e.preventDefault();
        $.Zebra_Dialog(''+msg , {
            'type':     'warning',
            'title':    'Sungard Quiz',
            'buttons':  [
                            {caption: 'Yes', callback: function() {document.forms["myform"].submit()}},
